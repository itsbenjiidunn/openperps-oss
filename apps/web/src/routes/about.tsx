      ...
      <section className="px-4 pt-16 pb-20 max-w-6xl mx-auto">
        <div className="flex flex-col items-center text-center">
          <img
            src={logo}
            alt="OpenPerps"
            className="h-32 w-32 drop-shadow-[0_0_40px_oklch(0.86_0.16_188_/_0.6)]"
          />
          ...
          <div className="mt-8 flex gap-3">
            <Link
              to="/app"
              className="btn-primary rounded-md px-5 py-2.5 text-sm font-semibold flex items-center gap-2"
            >
              Open terminal <ArrowRight className="h-4 w-4" />
            </Link>
            <Link
              to="/launch"
              className="btn-ghost-border rounded-md px-5 py-2.5 text-sm font-medium"
            >
              Launch a market
            </Link>
          </div>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-4">
          ...
          <Pill
            ...
            label="Oracle + funding accrual via crank"
          />
